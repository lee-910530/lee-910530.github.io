...
def get_personal_data():
    ...
    bio_text = f"""
                ...
                <p>
                    <a href="https://sshouhua.github.io/assets/pdf/hsin_cv.pdf" target="_blank" style="margin-right: 15px"><i class="fa fa-address-card fa-lg"></i> CV</a>
    ...
    footer = """
            <div class="col-sm-12" style="">
                <p>
                    &copy; Copyright 2025 Chang-Hsin Lee. 
